...
class Swap_a_z_policy:
    ...
    def __call__(self, env, state):
        ...
        # action mapping
        is_push_stage = self.stage_strategy[None, :].repeat(*self.batch_size, 1)[torch.arange(*self.batch_size), self.ts.long()] == 0
        ...
        self.did_load[action_is_push_load_to_pm, self.ts[action_is_push_load_to_pm].long()] = True  # push stage
        self.did_load[action_is_swap_load_to_pm, self.ts[action_is_swap_load_to_pm].long()] = True  # swap stage
        self.did_load[~action_is_unload_from_ll, self.ts[~action_is_unload_from_ll].long()] = True  # out loadlock
        self.did_load[action_is_push_unload_from_pm, self.ts[action_is_push_unload_from_pm].long()] = False # push stage
        self.did_load[action_is_swap_unload_from_pm, self.ts[action_is_swap_unload_from_pm].long()] = False # swap stage
        self.did_load[action_is_unload_from_ll, self.ts[action_is_unload_from_ll].long()] = False # in loadlock
    ...
    def get_swap_a_z_mask(self, env, state):
        ...
        # ------------------------------------------------------------------------------------------------------------
        swap_action_mask = torch.zeros_like(state.action_mask, dtype=torch.bool)
        before_loaded = self.did_load[torch.arange(*self.batch_size), self.ts.long()]
        ...
        # update
        self.did_load[ull_batch_idx, self.ts[ull_batch_idx].long()] = False
        self.did_load[lll_batch_idx, self.ts[lll_batch_idx].long()] = True
        ...
        self.did_load[load_to_push_pm_batch_idx, self.ts[load_to_push_pm_batch_idx].long()] = True
        ...
        self.did_load[load_to_swap_pm_batch_idx, self.ts[load_to_swap_pm_batch_idx].long()] = True
        ...
        self.did_load[unload_from_push_pm_batch_idx, self.ts[unload_from_push_pm_batch_idx].long()] = False
        ...
        self.did_load[unload_from_swap_pm_batch_idx, self.ts[unload_from_swap_pm_batch_idx].long()] = False
